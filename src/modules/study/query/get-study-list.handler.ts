...
//       .subQuery()
//       .select([
//         `studyPlan.studyId AS studyId,
//         studyPlan.studyPlanId AS studyPlanId,
//       studyPlan.studyMode AS studyMode`,
//       ])
//       .from(StudyPlan, 'studyPlan')
//       .groupBy('studyPlan.studyPlanId')
//       .getQuery();
...
//       ])
//       .leftJoinAndSelect(studyPlan, 'studyPlan', 'studyPlan.studyPlanId')
//       // .where('study.studyId = :studyPlan.studyId', {studyId: })
//       // .leftJoinAndSelect(studyPlan, 'studyPlan', 'studyPlan.studyPlanId')
//       .orderBy('study.studyId', 'ASC');

//     if (param.searchWord) {
//       study.where('study.studyName like :studyName', {
